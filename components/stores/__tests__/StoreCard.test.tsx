...
describe('StoreCard', () => {
  ...
  it('renders store name correctly', () => {
    const { getByText } = render(
      <StoreCard store={mockStore} onPress={mockOnPress} />
    );
  ...
  it('renders status badge for pending store', () => {
    ...
    const { getByText } = render(
      <StoreCard store={pendingStore} onPress={mockOnPress} />
    );
  ...
  it('renders status badge for rejected store', () => {
    ...
    const { getByText } = render(
      <StoreCard store={rejectedStore} onPress={mockOnPress} />
    );
  ...
  it('renders status badge for inactive store', () => {
    ...
    const { getByText } = render(
      <StoreCard store={inactiveStore} onPress={mockOnPress} />
    );
  ...
  it('handles missing category gracefully', () => {
    ...
    const { getByText } = render(
      <StoreCard store={storeWithoutCategory} onPress={mockOnPress} />
    );

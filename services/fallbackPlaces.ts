...
const places: FallbackPlace[] = [
  ...
  { id: 'fb-hospital', name: 'Hospital General Dr. Israel Ranuárez', description: 'Hospital Israel Ranuárez, San Juan de los Morros, Guárico', latitude: 9.9140, longitude: -67.3590, type: 'landmark', fullAddress: 'Hospital Israel Ranuárez, San Juan de los Morros, Guárico', source: 'custom' },
